...
import os
token ='8007014914:AAHCA4Wuhog-PX2m3v6Cptfu3kg85UElW3o'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '6473717870'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '6473717870':
		bot.reply_to(message, "ummmmmmmm")
		return
...
◆𝑷𝑹𝑶𝑿𝒀𝑺: 𝑷𝑹𝑶𝑿𝒀 𝑳𝑰𝑽𝑬 ✅ '''
				print(last)
				if 'success' in last or 'successfully' in last:
					live += 1
